...
class BookStoreApplicationTests {
	...
	void testGetBookComments() throws Exception {
		...
		mockMvc.perform(get(ROOT+"/"+book.getId()+"/comments")).andExpect(status().isOk())
	...
	void testUpdateBook() throws Exception {
		...
		var response = mockMvc
				.perform(put(ROOT+"/"+book.getId()).contentType(MediaType.APPLICATION_JSON).content(bookAsJson))
